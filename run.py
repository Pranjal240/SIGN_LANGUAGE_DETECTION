...
# Debounce state
data_state = {'hand_last': None, 'hand_count': 0, 'spoken_hand': None, 'pointer_last': None}
    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                if data_state['hand_count'] >= 6 and hand_text != data_state['spoken_hand']:
                    ...
                    speak_text(f"Detected hand sign: {msg}")
                ...
                if len(pre_ph) == history_length * 2:
                    ...
                    if fg_text in ['Clockwise', 'Counter Clockwise'] and fg_text != data_state['pointer_last']:
